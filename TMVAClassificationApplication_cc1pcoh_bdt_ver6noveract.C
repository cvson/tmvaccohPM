...
void TMVAClassificationApplication_cc1pcoh_bdt_ver6noveract( TString myMethodList = "" )
{
#ifdef __CINT__
    ...
    reader->AddSpectator( "ppdg", &ppdg );
    
    // --- Book the MVA methods
    
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_ver6noveract";//newchange
    ...
    //TString fname = "/home/cvson/cc1picoh/frkikawa/meAna/ip4tmva/data_merged_ccqe_addpid_ver6noveract.root";
    //TString fname = "/home/cvson/cc1picoh/frkikawa/meAna/ip4tmva/pm_merged_ccqe_tot_addpid_ver6noveract.root";
    //TString fname = "/home/cvson/cc1picoh/frkikawa/meAna/ip4tmva/pmbar_merged_ccqe_addpid_ver6noveract.root";
    //TString fname = "/home/cvson/cc1picoh/frkikawa/meAna/ip4tmva/ingrid_merged_nd3_ccqe_tot_addpid_ver6noveract.root";
    TString fname = "/home/cvson/cc1picoh/frkikawa/meAna/ip4tmva/wall_merged_ccqe_tot_addpid_ver6noveract.root";
    //
    ...
    theTree->SetBranchAddress( "pang", &pang );
    theTree->SetBranchAddress( "mupdg", &mupdg );
    theTree->SetBranchAddress( "ppdg", &ppdg );
    ...
    for (Long64_t ievt=0; ievt<nentries;ievt++) {
        ...
        Float_t pid_tem;
        if (Use["BDT"])      {
            if (!(Ntrack==2 && pang<90 && mumucl>0.6 && opening>10 && coplanarity>90 && pmucl>0.2)) pid_tem = -999;
