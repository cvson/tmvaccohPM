...
void TMVAClassificationApplication_cc1presv2cor_bdt_ver3noveractFFFSI( TString myMethodList = "",TString fname )
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_cc1presv2cor_ver3noveractFFFSI";//newchange
    ...
    TBranch *bpidfsi1prescor = theTree->Branch("pidfsi1prescor",&pidfsi1prescor,"pidfsi1prescor/F");
    ...
    for (Long64_t ievt=0; ievt<nentries;ievt++) {
        ...
        pidfsi1prescor = pidfsi_tem;
        bpidfsi1prescor->Fill();
