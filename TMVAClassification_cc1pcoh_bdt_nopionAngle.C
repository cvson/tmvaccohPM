...
#endif
/**************************************************************************/
/* remove prang, it's similar to range */
/* remove pion angle since it's not good reconstruction */
/* chane Factory TMVAClassification_noPionAngle */
/**************************************************************************/

void TMVAClassification_cc1pcoh_bdt_nopionAngle( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_bdt_noPionAngle.root" );//changehere
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    //changehere rename Factory
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_noPionAngle", outputFile,
