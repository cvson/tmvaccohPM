...
void TMVAClassification_cc1pcoh_knn( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_knn.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile,//newchange
    ...
    factory->AddSpectator( "mumucl", 'F' );
    factory->AddSpectator( "pang_t", 'F' );
    factory->AddSpectator( "coplanarity", 'F' );
    factory->AddSpectator( "mufc", 'I' );
    factory->AddSpectator( "pfc", 'I' );
    factory->AddSpectator( "ppe", 'F' );
    factory->AddSpectator( "mupe", 'F' );
    factory->AddSpectator( "range", 'F' );
    factory->AddSpectator( "prange", 'F' );
