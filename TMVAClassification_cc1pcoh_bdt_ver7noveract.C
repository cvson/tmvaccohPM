...
#endif
//this is with GENIE for the data
void TMVAClassification_cc1pcoh_bdt_ver7noveract( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_bdt_ver7noveract.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ver7noveract", outputFile,//newchange
    ...
    // ---------------------------------------------------------------
    // --- Add sample
    TString fgenieStr="/home/cvson/cc1picoh/frkikawa/meAna/ip4tmva/genie_merged_ccqe_coh.root";//newadd
    ...
    TFile *pfileGenie = new TFile(fgenieStr);//newadd
    ...
    TTree *ptree_genie  = (TTree*)pfileGenie->Get("tree");//newadd
    ...
    factory->AddSignalTree    ( ptree_genie,     signalWeight_sig );//newadd
   ...
   TCut mycuts = "Ntrack==2 && abs(inttype)==16 && fileIndex==0";
