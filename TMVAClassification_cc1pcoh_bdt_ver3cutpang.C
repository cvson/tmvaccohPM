...
void TMVAClassification_cc1pcoh_bdt_ver3cutpang( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_bdt_ver3cutpang.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ver3cutpang", outputFile,//newchange
    ...
    factory->AddSpectator( "pang", 'F' );//newadd
   ...
   TCut mycuts = "Ntrack==2 && abs(inttype)==16 && fileIndex==1 && pang<90"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
