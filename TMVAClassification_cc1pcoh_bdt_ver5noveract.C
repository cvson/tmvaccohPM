...
void TMVAClassification_cc1pcoh_bdt_ver5noveract( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_bdt_ver5noveract.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ver5noveract", outputFile,//newchange
   ...
   TCut mycuts = "Ntrack==2 && abs(inttype)==16 && fileIndex==1 && pang<90 && abs(mupdg)==13 && abs(ppdg)==211 "; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
