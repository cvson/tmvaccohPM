...
void TMVAClassificationApplication_cc1presv2_bdt_ver3noveractFF( TString myMethodList = "" )
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_cc1presv2_ver3noveractFF";//newchange
