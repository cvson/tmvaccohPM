...
void TMVAClassification_ccqecor_bdt_ver3noveractFFFSI( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_ccqecor_bdt_ver3noveractFFFSI.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
    
    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ccqecor_ver3noveractFFFSI", outputFile,//newchange
