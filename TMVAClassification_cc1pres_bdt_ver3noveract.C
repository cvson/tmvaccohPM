...
void TMVAClassification_cc1pres_bdt_ver3noveract( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pres_bdt_ver3noveract.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_cc1pres_ver3noveract", outputFile,//newchange
   ...
   TCut mycuts = "Ntrack==2 && (abs(inttype)==11 || abs(inttype)==13) && fileIndex==1"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "Ntrack==2 && (!(abs(inttype)==11 || abs(inttype)==13 || abs(inttype)==16)  || fileIndex>1)"; // for example: TCut mycutb = "abs(var1)<0.5";
