...
void TMVAClassificationApplication_ccqecor_bdt_ver3noveractFFFSI( TString myMethodList = "", TString fname )
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_ccqecor_ver3noveractFFFSI";//newchange
    ...
    TBranch *bpidfsiccqecor = theTree->Branch("pidfsiccqecor",&pidfsiccqecor,"pidfsiccqecor/F");
