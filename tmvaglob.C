...
namespace TMVAGlob {
   ...
   enum TypeOfPlot { kId = 0,
    ...
    static Int_t c_Canvas         = 10;//TColor::GetColor( "#f0f0f0" );
   //static Int_t c_FrameFill      = TColor::GetColor( "#fffffd" );
    static Int_t c_FrameFill      = 10;//TColor::GetColor( "#fffffd" );
   ...
   static Int_t c_BackgroundFill = TColor::GetColor( "#ff0000" );*/
    static Int_t c_SignalLine     = TColor::GetColor( "#0B3861" );
    static Int_t c_SignalFill     = 32;//TColor::GetColor( "#7d99d1" );
    static Int_t c_BackgroundLine = TColor::GetColor( "#B45F04" );
    static Int_t c_BackgroundFill = 42;//TColor::GetColor( "#ff0000" );
   ...
   void SetFrameStyle( TH1* frame, Float_t scale = 1.0 )
   {
      ...
      //frame->GetYaxis()->SetTitleSize( 0.045*scale );
       frame->GetXaxis()->SetTitleSize( 0.05*scale );
       frame->GetYaxis()->SetTitleSize( 0.05*scale );
