...
void TMVAClassificationApplication_ccqecornorange_bdt_ver3noveractFFFSI( TString myMethodList = "", TString fname )
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_ccqecornorange_ver3noveractFFFSI";//newchange
    ...
    TBranch *bpidfsiccqecornorange = theTree->Branch("pidfsiccqecornorange",&pidfsiccqecornorange,"pidfsiccqecornorange/F");
    ...
    for (Long64_t ievt=0; ievt<nentries;ievt++) {
        ...
        pidfsiccqecornorange = pidfsi_tem;
        bpidfsiccqecornorange->Fill();
