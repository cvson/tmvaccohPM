...
void TMVAClassification_cc1pcoh( TString myMethodList = "" )
{
   ...
   TString outfileName( "TMVA_cc1pcoh.root" );
   ...
   //factory->AddSpectator( "inttype", 'F' );
   ...
   if (gSystem->AccessPathName( fname ))  // file does not exist in local directory
    ...
    TString fsignalStr="/export/scraid3/data/kikawa/MC/pm/merged_ccqe_tot.root";
    TString fbarStr="/export/scraid3/data/kikawa/MC/pm_bar/merged_ccqe.root";
    TString fbgStr="/export/scraid3/data/kikawa/MC/wall/merged_ccqe_tot.root";
    TString fbg2Str="/export/scraid3/data/kikawa/MC/ingrid/merged_nd3_ccqe_tot.root";
    ...
    TFile *pfileBg = new TFile(fbgStr);
    TFile *pfileBg2 = new TFile(fbg2Str);
    TFile *pfileRatio = new TFile(fratioStr);
    
    TTree *ptree_sig  = (TTree*)pfileSignal->Get("tree");
    TTree *ptree_bar  = (TTree*)pfileBar->Get("tree");
    TTree *ptree_bg   = (TTree*)pfileBg->Get("tree");
    TTree *ptree_bg2  = (TTree*)pfileBg2->Get("tree");
    
    //POT normalization
    const int   nmcFile  = 3950;
    const int   nbarFile  = 986;
    const int   nbgFile  = 55546;//(31085+24461);
    const int   nbg2File  = 7882;//(3941+3941);
   ...
   TCut mycuts = "abs(inttype)==16"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "abs(inttype)!=16"; // for example: TCut mycutb = "abs(var1)<0.5";
