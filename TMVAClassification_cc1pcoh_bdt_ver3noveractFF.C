...
void TMVAClassification_cc1pcoh_bdt_ver3noveractFF( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_bdt_ver3noveractFF.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ver3noveractFF", outputFile,//newchange
