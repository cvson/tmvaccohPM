...
void TMVAClassification_ccqecornorange_bdt_ver3noveractFFFSI( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_ccqecornorange_bdt_ver3noveractFFFSI.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
    
    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ccqecornorange_ver3noveractFFFSI", outputFile,//newchange
    ...
    TCut mycuts = preselecet && "abs(inttype)==1 && fileIndex==1 && abs(mupdg)==13 && abs(ppdg)==2212"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
    TCut mycutb = preselecet && "!(abs(inttype)==1 && fileIndex==1 && abs(mupdg)==13 && abs(ppdg)==2212)"; // for example: TCut mycutb = "abs(var1)<0.5";
