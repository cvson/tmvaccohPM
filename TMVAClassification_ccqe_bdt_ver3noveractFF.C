...
void TMVAClassification_ccqe_bdt_ver3noveractFF( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_ccqe_bdt_ver3noveractFF.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ccqe_ver3noveractFF", outputFile,//newchange
   ...
   TCut mycuts = "Ntrack==2 && abs(inttype)==1 && fileIndex==1"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "Ntrack==2 && (!(abs(inttype)==1 || abs(inttype)==16)  || fileIndex>1)"; // for example: TCut mycutb = "abs(var1)<0.5";
