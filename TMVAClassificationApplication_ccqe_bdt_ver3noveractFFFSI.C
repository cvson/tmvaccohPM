...
void TMVAClassificationApplication_ccqe_bdt_ver3noveractFFFSI( TString myMethodList = "", TString fname )
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_ccqe_ver3noveractFFFSI";//newchange
    ...
    Float_t pidfsiccqe;
    TBranch *bpidfsiccqe = theTree->Branch("pidfsiccqe",&pidfsiccqe,"pidfsiccqe/F");
