...
void TMVAClassification_cc1pcoh_bdt_ver4noveract( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1pcoh_bdt_ver4noveract.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_ver4noveract", outputFile,//newchange
    ...
    factory->AddVariable( "pang", 'F' );//use pang instead of pang_t
