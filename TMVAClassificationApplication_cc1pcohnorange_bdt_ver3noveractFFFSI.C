...
void TMVAClassificationApplication_cc1pcohnorange_bdt_ver3noveractFFFSI( TString myMethodList = "", TString fname)
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_cc1pcohnorange_ver3noveractFFFSI";//newchange
   ...
   //TString fname = "/home/cvson/scraid2/cc1picoh/FIT/datafsi/pmnue_merged_ccqe_tot_addpidFFnew.root"; 
    ...
    TBranch *bpidfsinorange = theTree->Branch("pidfsinorange",&pidfsinorange,"pidfsinorange/F");
    ...
    for (Long64_t ievt=0; ievt<nentries;ievt++) {
        ...
        Float_t pidfsinorange_tem;
        if (Use["BDT"])      {
            //if (Ntrack!=2) pidfsinorange_tem = -999;//changehere
            if (Ntrack<2) pidfsinorange_tem = -999;
            else pidfsinorange_tem = reader->EvaluateMVA("BDT method");
        }
        pidfsinorange = pidfsinorange_tem;
        bpidfsinorange->Fill();
