...
void TMVAClassification_cc1presv2_bdt_ver3noveract( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    TString outfileName( "TMVA_cc1presv2_bdt_ver3noveract.root" );//newchange
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    // Create the factory object.
    TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification_cc1presv2_ver3noveract", outputFile,//newchange
