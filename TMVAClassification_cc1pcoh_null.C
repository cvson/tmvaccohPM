...
void TMVAClassification_cc1pcoh_null( TString myMethodList = "" )
{
    //---------------------------------------------------------------
    ...
    //TString outfileName( "TMVA_cc1pcoh_null.root" );
    TString outfileName( "TMVA_cc1pcoh_null_2trk.root" );
    ...
    //factory->AddVariable( "Ntrack", 'I' );
    factory->AddVariable( "Ningtrack", 'I' );
    factory->AddVariable( "muang", 'F' );
    factory->AddVariable( "pang", 'F' );
    factory->AddVariable( "ppe", 'F' );
    factory->AddVariable( "mupe", 'F' );
    factory->AddVariable( "opening", 'F' );
    factory->AddVariable( "coplanarity", 'F' );
    factory->AddVariable( "nuE", 'F' );
    factory->AddVariable( "veract", 'F' );
    
    factory->AddVariable( "mumucl", 'F' );
    factory->AddVariable( "pmucl", 'F' );
    factory->AddVariable( "muang_t", 'F' );
    factory->AddVariable( "pang_t", 'F' );

    factory->AddVariable( "range", 'F' );
    factory->AddVariable( "pene", 'F' );
    
    factory->AddVariable( "prange", 'F' );
    factory->AddVariable( "ppene", 'F' );
    
    factory->AddVariable( "muscirange", 'F' );
    factory->AddVariable( "muironrange", 'F' );
    
    factory->AddVariable( "pscirange", 'F' );
    factory->AddVariable( "pironrange", 'F' );
    
    factory->AddVariable( "tmomtrans", 'F' );
    ...
    //**Reprocess to fix prang bug
    TString fsignalStr="/home/cvson/cc1picoh/dataProcess/prangefix/pm_merged_ccqe_tot.root";
    TString fbarStr="/home/cvson/cc1picoh/dataProcess/prangefix/pmbar_merged_ccqe.root";
    TString fbkgStr="/home/cvson/cc1picoh/dataProcess/prangefix/wall_merged_ccqe_tot.root";
    TString fbkg2Str="/home/cvson/cc1picoh/dataProcess/prangefix/ingrid_merged_nd3_ccqe_tot.root";
