...
void TMVAClassificationApplication_cc1presv2_bdt_ver3noveractFFFSI( TString myMethodList = "",TString fname )
{
#ifdef __CINT__
    ...
    TString dir    = "weights/";
    TString prefix = "TMVAClassification_cc1presv2_ver3noveractFFFSI";//newchange
    ...
    Float_t pidfsi1pres;
    TBranch *bpidfsi1pres = theTree->Branch("pidfsi1pres",&pidfsi1pres,"pidfsi1pres/F");
